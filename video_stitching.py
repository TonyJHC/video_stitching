...
class VideoStitcher:
    def __init__(self, left_video_in_path, right_video_in_path, video_out_path, video_out_width=1280, video_out_height=720, display=False):
...
stitcher = VideoStitcher(left_video_in_path='D:/jupyter_dir/RegalaX/data/video/football_left.mp4',
                         right_video_in_path='D:/jupyter_dir/RegalaX/data/video/football_right.mp4',
                         video_out_path='D:/jupyter_dir/RegalaX/data/output/stitching_output_no_resize.mp4'
                         )
stitcher.run()